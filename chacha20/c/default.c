#include <stdint.h>
void verse_chacha20_c_default(uint32_t (*blockPtr)[16], uint64_t counter, uint32_t p0[8], uint32_t p1[3], uint32_t p2[1])
{
    /*    Local variables    */
    ...
    while(counter > 0)
    {
        ...
        rx2 =  0x79622d32;
        rx3 =  0x6b206574;
        rx4 =  verse_from_le32(p0[0]);
        rx5 =  verse_from_le32(p0[1]);
        rx6 =  verse_from_le32(p0[2]);
        rx7 =  verse_from_le32(p0[3]);
        rx8 =  verse_from_le32(p0[4]);
        rx9 =  verse_from_le32(p0[5]);
        rx10 =  verse_from_le32(p0[6]);
        rx11 =  verse_from_le32(p0[7]);
        rx12 =  rctr;
        rx13 =  verse_from_le32(p1[0]);
        rx14 =  verse_from_le32(p1[1]);
        rx15 =  verse_from_le32(p1[2]);
        rx0 += rx4;
        rx12 ^= rx0;
